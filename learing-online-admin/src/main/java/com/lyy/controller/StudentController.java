...
//        } catch (Exception e) {
//            e.printStackTrace();
//            throw new AppException(ErrorCode.SERVICE_SPECIALTY_SAVE_FAIL_ERROR, "学生账号保存失败");
//        }
...
//        } catch (Exception e) {
//            e.printStackTrace();
//            throw new AppException(ErrorCode.SERVICE_SPECIALTY_UPDATE_FAIL_ERROR, "学生账号更新失败");
//        }
...
//        } catch (Exception e) {
//            e.printStackTrace();
//            throw new AppException(ErrorCode.SERVICE_SPECIALTY_DELETE_FAIL_ERROR, "学生账号删除失败");
//        }
